...
jQuery( document ).ready( function ( $ ) {
	...
	$( '.at-gsm-btn' ).click( function ( e ) {
		...
		$( this ).text( ample_shop_adi_install.btn_text );
		...
		$.ajax({
			...
			data: {
				...
				security : ample_shop_adi_install.nonce,
				...
				setTimeout(function(){
					$.ajax({
						...
						success:function( response ) {
							...
							redirect_uri         = ample_shop_adi_install.adminurl+'/themes.php?page=advanced-import&browse=all';
